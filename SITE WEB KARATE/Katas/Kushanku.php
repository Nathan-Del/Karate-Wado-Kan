...
<body>
    ...
    <main>
      ...
      <h4 class="kata-centre" >Kushanku</h4>
      <div class="kata-info">
          <p>Origine : 1761-Chine – Envoy Kusanku</p>
          <p>Description : Le créateur de ce Kata serait un maître chinois nommé Kwang Shang Fu présent sur l’île d’Okinawa au 18ème siècle. L’école Shito-Ryu le nomme « Kosokun ». Le fondateur du style Shotokan (Gichin Funakoshi) le nomme « Kanku » (regard « kan » vers le ciel « ku ») en référence au premier mouvement du Kata, symbolisant l’univers.</p>
        </section>
      </div>
      <center><iframe width="560" height="315" src="https://www.youtube.com/embed/1SZjIfSXwB4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
      <br>
      <br>
      <br>
